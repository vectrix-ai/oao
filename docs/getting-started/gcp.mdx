...
the organization-wide offboarding action. Keep the worker private and do not
use service-account keys. The [Authentication reference](/reference/authentication)
