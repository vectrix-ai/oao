...
OpenRouter, OpenAI, or Anthropic provider in PostgreSQL. Runnable deployments do not expose a
...
Hosted model identifiers start with `openrouter/`, `openai/`, or `anthropic/`
